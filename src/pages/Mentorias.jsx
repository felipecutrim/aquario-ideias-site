...
import { mentorias } from '../data/mentorias'
        ...
        <table className="w-full text-left text-sm">
          <thead className="bg-secondary-light text-primary">
            <tr>
              ...
              <th className="px-4 py-3 font-semibold">Responsável da Startup</th>
              <th className="px-4 py-3 font-semibold">Área da Mentoria</th>
              <th className="px-4 py-3 font-semibold">Mentor</th>
              <th className="px-4 py-3 font-semibold">Data da Solicitação</th>
              <th className="px-4 py-3 font-semibold">Status</th>
              <th className="px-4 py-3 font-semibold">Data do Agendamento</th>
              <th className="px-4 py-3 font-semibold">Data da Mentoria</th>
              <th className="px-4 py-3 font-semibold">Relatório Recebido</th>
              <th className="px-4 py-3 font-semibold">Pagamento do Mentor</th>
          ...
          <tbody className="divide-y divide-secondary-light">
            {mentorias.map((sessao) => (
              <tr key={sessao.id}>
                ...
                <td className="px-4 py-3 text-neutral-600">{sessao.area}</td>
                <td className="px-4 py-3 text-neutral-600">{sessao.mentor}</td>
                <td className="px-4 py-3 text-neutral-600">
      ...
      <div className="mt-8 space-y-3 md:hidden">
        {mentorias.map((sessao) => (
          ...
          >
            ...
            <p className="text-sm text-neutral-600">
              <span className="font-medium text-neutral-500">Mentor: </span>
              {sessao.mentor}
            </p>
            <p className="text-sm text-neutral-600">
              <span className="font-medium text-neutral-500">
